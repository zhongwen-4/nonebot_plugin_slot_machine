...
PAYOUT_TABLE: Final[dict[str, dict[int, int]]] = {
    "A": {3: 50, 4: 100, 5: 150, 6: 170},
    "B": {3: 30, 4: 60, 5: 100, 6: 140},
    "C": {3: 20, 4: 40, 5: 80, 6: 100},
    "D": {3: 20, 4: 40, 5: 80, 6: 100},
    "E": {3: 10, 4: 25, 5: 60, 6: 80},
    "F": {3: 10, 4: 25, 5: 60, 6: 80},
    "G": {3: 8, 4: 15, 5: 30, 6: 50},
    "H": {3: 8, 4: 15, 5: 30, 6: 50},
}
